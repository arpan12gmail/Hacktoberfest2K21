...
int main()
     ...
     char choice;
     char playername[20];
     char ch1[]="1.Which of the following is a Palindrome number ?";
     char ch2[]="2.The country with the highest environmental performance index is... ?";
     char ch3[]="3.Which animal laughs like human being ?";
     char ch4[]="4.Who was awarded the youngest player award in Fifa World Cup 2006 ?";
     char ch5[]=" ?";
     mainhome:
     system("cls");
    ...
    // r1=i;
     ...
     switch(i)
        ...
        case 6:
		printf("\n\n\n6.What is the group of frogs known as?");
